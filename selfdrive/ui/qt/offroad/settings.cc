...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  speedToggles->addItem(new CValueControl("AutoHighWayForkDecalRate", "ATC 高速进匝道口前降速比率(70%)", "在进匝道口把车速降至道路限速的比率,0表示关闭此功能", 0, 1000, 5));
  ...
  speedToggles->addItem(new CValueControl("ContinuousLaneChangeCnt", "ATC 允许连续变道次数(0)", "允许连续变道的次数", 0, 4, 1));
