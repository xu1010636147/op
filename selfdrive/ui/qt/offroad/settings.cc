...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  navToggles->addItem(new CValueControl("AutoEnTurnNewLaneTimeH", "H 高速再次提前变道的新车道出现时间(10s)", "车辆已在最侧边车道，若新车道出现的时间超过设置值后允许再次变道，-1 关闭", -1, 120, 1));
  ...
  navToggles->addItem(new CValueControl("AutoEnTurnNewLaneTime", "L 公路再次提前变道的新车道出现时间(5s)", "车辆已在最侧边车道，若新车道出现的时间超过设置值后允许再次变道，-1 关闭", -1, 120, 1));
