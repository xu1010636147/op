...
def get_default_params():
  default_params : list[tuple[str, str | bytes]] = [
    ...
    ("CanfdHDA2", "0"),
    ("CanfdDebug", "0"),
    ("SoundVolumeAdjust", "200"),
    ("SoundVolumeAdjustEngage", "200"),
    ("TFollowGap1", "110"),
    ("TFollowGap2", "130"),
    ("TFollowGap3", "180"),
    ("TFollowGap4", "220"),
    ...
    ("ContinuousLaneChangeInterval", "1"),
    ("AutoTurnLeft", "1"),
    ("AutoUpRoadLimit", "0"),
    ("AutoUpHighwayRoadLimit", "0"),
    ("AutoForkDistOffsetH", "1800"),
    ("AutoEnTurnNewLaneTimeH", "10"),
    ("AutoDoForkDecalDistH", "150"),
    ("AutoDoForkDecalDist", "100"),
    ("AutoDoForkCheckDistH", "0"),
    ("AutoDoForkBlinkerDistH", "120"),
    ("AutoDoForkNavDistH", "80"),
    ("AutoForkDecalRateH", "80"),
    ("AutoForkSpeedMinH", "60"),
    ("AutoKeepForkSpeedH", "15"),
    ("AutoForkDecalRate", "80"),
    ("AutoForkSpeedMin", "45"),
    ("AutoKeepForkSpeed", "10"),
    ("AutoForkDistOffset", "200"),
    ("AutoEnTurnNewLaneTime", "0"),
    ("AutoDoForkCheckDist", "10"),
    ("AutoDoForkBlinkerDist", "50"),
    ("AutoDoForkNavDist", "30"),
