...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  navToggles->addItem(new CValueControl("AutoForkDistOffsetH", "H 高速提前变道靠边的距离(1000m)", "在距离匝道口多少米时开始变道到最侧面车道", 0, 2000, 5));
  navToggles->addItem(new CValueControl("AutoDoForkDecalDistH", "H 高速进匝道口提前减速的距离(50m)", "在距离匝道口多少米时开始减速", 0, 500, 5));
  navToggles->addItem(new CValueControl("AutoDoForkBlinkerDistH", "H 高速进匝道口提前打灯的距离(10m)", "在距离匝道口多少米时开始打转身灯准备变道，但不是一定会立即变道，还需要等匝道出现的条件成立", 0, 200, 2));
  navToggles->addItem(new CValueControl("AutoDoForkCheckDistH", "H 高速提前识别出现匝道口的距离(3m)", "在靠近匝道口时提前识别匝道口出现的距离，是在模型预留的轨迹上提前检测的距离", 0, 100, 1));
  ...
  navToggles->addItem(new CValueControl("AutoDoForkDecalDist", "L 公路进分叉口提前减速的距离(20m)", "在距离公路分叉口多少米时开始减速", 0, 500, 5));
  navToggles->addItem(new CValueControl("AutoDoForkBlinkerDist", "L 公路进分叉口提前打灯距离(5m)", "在距离公路分叉口多少米时提前打转向灯准备变道，但不是一定会立即变道，还需要等分叉口出现的条件成立", 0, 200, 1));
  navToggles->addItem(new CValueControl("AutoDoForkCheckDist", "L 公路提前识别出现分叉口的距离(2m)", "在靠近公路分叉口时提前识别分叉口出现的距离，是在模型预留的轨迹上提前检测的距离", 0, 100, 1));
  ...
  navToggles->addItem(new CValueControl("ContinuousLaneChangeInterval", "ATC 连续变道时间间隔(2秒)", "变道后允许再次变道的时间间隔(秒)", 0, 30, 1));
  navToggles->addItem(new CValueControl("AutoTurnLeft", "ATC 允许自动向左变道(0)", "0-需要驾驶员打左转向灯变道, 1-允许自动左变道", 0, 1, 1));
  navToggles->addItem(new CValueControl("AutoUpRoadLimit", "自动提高低于60km/h的公路限速(0)", "0-关闭，1-当普通公路限速低于60时，会把道路限速加上提速偏移值", 0, 1, 1));
  navToggles->addItem(new CValueControl("AutoUpRoadLimit40KMH", "低于40km/h的公路提速偏移(15km/h)", "允许提高限速时，会把道路限速加上此提速偏移值", 0, 50, 1));
  navToggles->addItem(new CValueControl("AutoUpHighwayRoadLimit", "自动提高低于60km/h的匝道限速(0)", "0-关闭，1-当高速公路限速低于60时，会把道路限速加上提速偏移值", 0, 1, 1));
  navToggles->addItem(new CValueControl("AutoUpHighwayRoadLimit40KMH", "低于40km/h的匝道提速偏移(20km/h)", "允许提高限速时，会把道路限速加上此提速偏移值", 0, 50, 1));
