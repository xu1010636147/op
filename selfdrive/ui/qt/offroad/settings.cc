...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  navToggles->addItem(new CValueControl("AutoDoForkBlinkerDistH", "H 高速进匝道口提前打灯的距离(30m)", "在距离匝道口多少米时开始打转身灯准备变道，但不是一定会立即变道，还需要等匝道出现的条件成立", 0, 200, 2));
  ...
  navToggles->addItem(new CValueControl("AutoDoForkBlinkerDist", "L 公路进分叉口提前打灯距离(15m)", "在距离公路分叉口多少米时提前打转向灯准备变道，但不是一定会立即变道，还需要等分叉口出现的条件成立", 0, 200, 1));
