...
class CAR(Platforms):
  ...
  BYD_TANG_DMI_23 = BydPlatformConfig(
    [BydCarDocs("BYD TANG DMI 23")],
    CarSpecs(mass=2153., wheelbase=2.850, steerRatio=15.0, centerToFrontRatio=0.44, tireStiffnessFactor=1.0),
  )
...
PLATFORM_TANG_DMI = {CAR.BYD_TANG_DMI_21,CAR.BYD_TANG_DMI_23}
...
MPC_ACC_CAR = {CAR.BYD_HAN_DM_20, CAR.BYD_HAN_EV_20, CAR.BYD_TANG_DM, CAR.BYD_TANG_DMI_21}

# power train canbus contains mrr radar info
PT_RADAR_CAR = {CAR.BYD_HAN_DM_20, CAR.BYD_HAN_EV_20, CAR.BYD_TANG_DM, CAR.BYD_TANG_DMI_21}

# use torque lat control, otherwise use angle mode
TORQUE_LAT_CAR = {CAR.BYD_HAN_DM_20, CAR.BYD_HAN_EV_20, CAR.BYD_TANG_DM, CAR.BYD_SONG_PLUS_DMI_21, CAR.BYD_TANG_DMI_21}

# use experimental long mode
EXP_LONG_CAR = {CAR.BYD_HAN_DM_20, CAR.BYD_HAN_EV_20, CAR.BYD_TANG_DM, CAR.BYD_SONG_PLUS_DMI_21, CAR.BYD_TANG_DMI_21}
